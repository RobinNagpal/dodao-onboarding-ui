        ...
        <template v-if="isLoaded">
          <template v-if="selectedServerInfo && selectedServerInfo.id">
            <div class="mt-6 flex flex-col">
              ...
              <div class="w-full">
                <a
                  class="ml-2 text-primary underline text-xs mt-2 float-right mr-2"
                  :href="url"
                >
          ...
          <div class="my-6" v-else>
            <a
              class="text-white discord-btn inline-flex button px-[24px]"
              :href="url"
            >
              <svg
              ...
              <div
                class="h-[32px] w-full overflow-hidden rounded-full mr-2 items-center justify-center"
              >
