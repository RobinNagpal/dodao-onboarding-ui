...
import { AddDiscordCredentials_payload, AddDiscordCredentialsVariables } from '@/graphql/generated/graphqlDocs';
...
const url = computed(() => {
  const params = new URLSearchParams({
    scope: 'identify bot guilds guilds.join guilds.members.read email connections',
        ...
        <template v-if="isLoaded">
          <template v-if="selectedServerInfo && selectedServerInfo.id">
            <div class="mt-6 flex flex-col">
              ...
              <div class="w-full">
                <a class="ml-2 text-primary underline text-xs mt-2 float-right mr-2" :href="url">
          ...
          <div class="my-6" v-else>
            <a class="text-white discord-btn inline-flex button px-[24px]" :href="url">
